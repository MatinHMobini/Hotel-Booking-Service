          ...
          <div>
            {bookings.map((booking) => (
              ...
              <p key={booking.booking_id}>
                ...
                Booking Date: {booking.booking_date}, Hotel Address:{" "}
                {booking.hotel_address}, Capacity: {booking.capacity}, Price:{" "}
                {booking.price}
                <Link aria-current="page" to="/renting" state={booking}>
                  <Button>Change to Rent</Button>
                </Link>
              </p>
            ))}
          </div>
